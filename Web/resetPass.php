...
if(isset($_POST["email"]) && isset($_POST["action"]) && ($_POST["action"]=="update")){
  ...
  if ($pass1!=$pass2){
    ...
    mysqli_query($koneksi, "UPDATE pembeli SET password_pbl ='$pass1' WHERE email = '$email'");
                    ...
                    <div class="forms-wrap">
                        <form method="POST" action="" name="update">
                            ...
                            <div class="heading text-center">
                                <h2>Halo!! </h2>
                                <h6>Silahkan Ubah Password-Mu!!</h6>
                            </div>
                            <div class="actual-form">
                                <input type="hidden" name="action" value="update" />
                                <br /><br />
                                <div class="input-wrap">
                                    <input type="Password" name="pass1" minlength="8" maxlength="20" class="input-field"
                                        autocomplete="off" required />
                                    <label>Password Baru</label>
                                </div>
                                <div class="input-wrap">
                                    <input type="Password" name="pass2" minlength="8" maxlength="20" class="input-field"
                                        autocomplete="off" required />
