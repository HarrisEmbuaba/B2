...
public class validasi extends AppCompatActivity {
    ...
    public void SendEmail(){
        ...
        JavaMailAPI javaMailAPI = new JavaMailAPI(validasi.this,email,header,pesan);
        javaMailAPI.execute();
    }
        ...
        if (inputKodeUSer.equals(kodeVerif)){
            ...
            verifEmailCall.enqueue(new Callback<VerifEmail>() {
                ...
                public void onResponse(Call<VerifEmail> call, Response<VerifEmail> response) {
                    ...
                    if (kode == 1){
                        Toast.makeText(validasi.this, "Berhasil Verif", Toast.LENGTH_SHORT).show();
                        Intent i = new Intent(getApplicationContext(), login.class);
                        i.putExtra("UserId",id_user);
                        startActivity(i);
                        finish();
                    } else {
                        Toast.makeText(validasi.this, "Gagal Verif", Toast.LENGTH_SHORT).show();
                    }
                }
