...
import com.example.po3.detailbarang;
    ...
    public void onBindViewHolder(@NonNull HolderData holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mIntent.putExtra("barang_jenis", listData.get(position).getJenis());
                mIntent.putExtra("nama_barang", listData.get(position).getNama());
